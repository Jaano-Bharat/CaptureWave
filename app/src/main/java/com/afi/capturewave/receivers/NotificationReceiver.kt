...
class NotificationReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val file =
            (context.applicationContext as App).fileRepository.getOutputDir().findFile(fileName)
        ...
        NotificationManagerCompat.from(context).cancel(NotificationHelper.RECORDING_FINISHED_N_ID)
    }
}