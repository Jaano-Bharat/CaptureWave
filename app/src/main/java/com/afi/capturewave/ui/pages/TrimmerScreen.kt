...
import com.afi.capturewave.ui.components.PlayerController
import com.afi.capturewave.ui.components.playPause
import com.afi.capturewave.ui.models.TrimmerModel
        ...
        Column(
            ...
            Row(
                ...
                Button(onClick = {
                    ...
                    Text(text = "${stringResource(R.string.stop_timestamp)} ${
    ...
    with(trimmerModel) {
        if (trimmerState != TrimmerState.NoJob) {
            ...
            AlertDialog(onDismissRequest = {
                ...
                Button(
                    onClick = { trimmerState = TrimmerState.NoJob }, enabled = (notRunning)
                ) {
                ...
                Box(
                    contentAlignment = Alignment.Center, modifier = Modifier.alpha(0.3f)
                ) {
                    Image(
                    ...
                    Image(
                        modifier = Modifier.size(250.dp), painter = rememberAnimatedVectorPainter(
                            animatedImageVector = image, atEnd = notRunning
