...
import com.afi.capturewave.canvas.CanvasOverlay
import com.afi.capturewave.enums.AudioSource
import com.afi.capturewave.enums.RecorderState
import com.afi.capturewave.services.AudioRecorderService
import com.afi.capturewave.services.LosslessRecorderService
import com.afi.capturewave.services.RecorderService
import com.afi.capturewave.services.ScreenRecorderService
...
class RecorderModel : ViewModel() {
    ...
    fun hasScreenRecordingPermissions(context: Context): Boolean {
        val overlayEnabled = Preferences.prefs.getBoolean(
            Preferences.showOverlayAnnotationToolKey, true
        )
